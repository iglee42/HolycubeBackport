...
public class EyeblossomBlock extends FlowerBlock {
    ...
    public void animateTick(BlockState p_382850_, Level p_382933_, BlockPos p_382838_, RandomSource p_383190_) {
        if (this.type.emitSounds() && p_383190_.nextInt(700) == 0) {
            ...
            if (blockstate.is(HolyPOBlocks.PALE_MOSS_BLOCK)) {
                p_382933_.playLocalSound((double)p_382838_.getX(), (double)p_382838_.getY(), (double)p_382838_.getZ(), HolyPOSounds.EYEBLOSSOM_IDLE.get(), SoundSource.BLOCKS, 1.0F, 1.0F, false);
            }
        }
    ...
    public static enum Type {
        OPEN(true, MobEffects.BLINDNESS, 11.0F, HolyPOSounds.EYEBLOSSOM_OPEN_LONG, HolyPOSounds.EYEBLOSSOM_OPEN, 16545810),
        CLOSED(false, MobEffects.CONFUSION, 7.0F, HolyPOSounds.EYEBLOSSOM_CLOSE_LONG, HolyPOSounds.EYEBLOSSOM_CLOSE, 6250335);
        ...
        public Block block() {
            return this.open ? HolyPOBlocks.OPEN_EYEBLOSSOM : HolyPOBlocks.CLOSED_EYEBLOSSOM;
        }
